...
impl Game {
    pub fn new(renderer: &mut Renderer) -> Game{
        ...
        let compute_pipeline = ComputePipeline::new(
             &renderer.device,
             "examples/fractals/shaders/fractal_shader.comp".to_string(),
        ...
        let graphics_pipeline = GraphicsPipeline::new(
            ...
            "examples/fractals/shaders/present_shader.vert".to_string(),
            "examples/fractals/shaders/present_shader.frag".to_string(),
            &[&descriptor_set_layout]
        );
...
impl GameHandler for Game {
    ...
    fn render(&mut self, render_context: &RenderContext) {
        ...
        render_context.command_buffer.image_barrier(
        ...
        render_context.command_buffer.dispatch(( 1000f32 / 32f32 ).ceil() as u32, ( 1000f32 / 32f32 ).ceil() as u32, 1);
